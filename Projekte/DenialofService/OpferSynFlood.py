...
def OpferSynFlood_Menu():
	...
	while(showMenu):
		...
		print('Hier in diesem Abschnitt wird der Apache2-Server gestartet der im SYN-Flooding Tutorial angegriffen wird.')
		...
		ipAttacker = raw_input('Bitte die Angreifer IP-Adresse(IPv4) eingeben: ')
		...
		print('ip.addr == ' +ipVictim + ' && ip.addr == ' +ipAttacker)
	 	...
	 	selection = raw_input(shellCols.BLUE + '\nDrücke ENTER um den Server zu stoppen ' + shellCols.ENDC)
