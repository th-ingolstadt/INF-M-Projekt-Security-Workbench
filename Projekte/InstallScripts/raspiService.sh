...
# 
echo "denyinterfaces wlan0 wlan1 wlan2 wlan3 wlan4 eth1"  >>/etc/dhcpcd.conf
...
sed -i 's/INTERFACESv4=\"\"/INTERFACESv4=\"eth1 wlan1 wlan2 wlan3 wlan4\"/g' /etc/default/isc-dhcp-server
#Configurare
echo "# dhcpd.conf
#
...
export ARP_WEB_RES_PATH='/home/pi/INF-M-Projekt-Workbench/Projekte/ARPspoofing/server/html'
...
echo "Genauere Infos Findet man in der Dokumentation"
echo "RPI wird in 30 Secunden Automatisch neugestartet mit ctrl +c Abbrechen"
echo "############################################################"
sleep 30
sudo reboot
