...
def do():
	...
	while(showMenu):
		...
		##Schritt 1
		print('Schaue dir zuerst den Quellcode von SecondExample.c in einem TextEditor an und versuche nachzuvollziehen, was dort gemacht wird. Solltest du Hilfe benötigen, schau dir die Erklärung im PDF-Handbuch der THI Security Workbench in Kapitel Buffer Overflow an.\n')
		...
		##Schritt 3
		print('Jetzt wird der GNU Debugger in einem eigenen Terminal gestartet, um den Assembler Code des gerade eben erstellten Programmes FirstExample zu debuggen. In diesem Terminal werden die Befehle gegeben, die zum Debuggen benutzt werden müssen.\n')
		...
		##Schritt 6
		print('Starte nun das ausführbare Programm SecondExample aus dem Unterordner BufferOverflow und gib als Eingabewert einen String mit so vielen Stellen mit, dass das Passwort noch nicht mit ausgegeben wird.\n')
		command = rlinput('Starte SecondExample mit folgendem Befehl: ', './BufferOverflow/SecondExample <Deine Eingabe>')
		os.system(command)
		print('\n')

		##Schritt 7
		print('Starte nun das ausführbare Programm SecondExample aus dem Unterordner BufferOverflow und gib als Eingabewert einen String mit so vielen Stellen mit, dass das Passwort mit ausgegeben wird.\n')
		command = rlinput('Starte SecondExample mit folgendem Befehl: ', './BufferOverflow/SecondExample <Deine Eingabe>')
		os.system(command)
		print('\n')
