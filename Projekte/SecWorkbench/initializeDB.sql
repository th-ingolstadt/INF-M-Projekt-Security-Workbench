...
insert into vulnerableDB.xssGuestbook (User, Date, comment) values ('admin', '2017-11-15', 'Guten Tag! Es freut mich sehr, dass ich hiermit den ersten Beitrag in unserem Gästebuch erstellen darf und möchte dich herlich Willkommen heißen! :)');
insert into vulnerableDB.xssGuestbook (User, Date, comment) values ('admin', '2017-11-15', 'Was wohl mit diesem stored cross site scripting ales möglich ist');
insert into vulnerableDB.xssGuestbook (User, Date, comment) values ('admin', '2017-11-16', 'Wenn ich an Cookies denke, dann frage ich mich manchmal was dort drin steht.. manchmal hab ich auch einfach nur Lust auf einen Cookie :D');
insert into vulnerableDB.xssGuestbook (User, Date, comment) values ('Mr. Robot', '2017-11-18', '42');
insert into vulnerableDB.xssGuestbook (User, Date, comment) values ('root', '2017-11-20', 'Hello World!');
insert into vulnerableDB.xssGuestbook (User, Date, comment) values ('root', '2017-11-21', '1 + 1 = 0');
insert into vulnerableDB.xssGuestbook (User, Date, comment) values ('Mr. Robot', '2017-11-22', 'Knock, knock. Race condition. Who’s there.');
insert into vulnerableDB.xssGuestbook (User, Date, comment) values ('Mr. Robot', '2017-11-25', 'Why do Java programmers wear glasses? Because they don’t C#!');
